...
export default function Footer({ activeTab, setActiveTab }) {
  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-[#0a0a0c] border-t border-zinc-800 pb-5 pt-3 px-4 z-50 shadow-[0_-10px_20px_rgba(0,0,0,0.5)]">
          ...
          return (
            <button
              ...
              className={`flex-1 py-2.5 px-1 rounded-xl text-center text-[11px] font-semibold tracking-wider transition-all duration-300 active:scale-95
                ${isActive 
                  ? 'bg-gradient-to-r from-[#c85a32]/10 to-[#148346]/10 text-white border border-[#c85a32]/40 shadow-[0_4px_15px_rgba(200,90,50,0.15)]' 
